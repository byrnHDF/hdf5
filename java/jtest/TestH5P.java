...
public class TestH5P {
    ...
    long fcpl_id                        = H5I_INVALID_HID();
    long ocpl_id                        = H5I_INVALID_HID();
    long ocp_plist_id                   = H5I_INVALID_HID();
    long lcpl_id                        = H5I_INVALID_HID();
    long plapl_id                       = H5I_INVALID_HID();
    long plist_id                       = H5I_INVALID_HID();
    long gapl_id                        = H5I_INVALID_HID();
    long gcpl_id                        = H5I_INVALID_HID();
    long acpl_id                        = H5I_INVALID_HID();
    ...
    public void testH5Pset_elink_acc_flags()
    {
        ...
        assertEquals(H5F_ACC_RDWR(), get_flags);
    }
    ...
    public void testH5P_fill_value()
    {
        ...
        try {
            ...
            fill_value[0] = 255;
            H5.H5Pset_fill_value(ocpl_id, H5T_NATIVE_INT_g(), fill_value);
            H5.H5Pget_fill_value(ocpl_id, H5T_NATIVE_INT_g(), fill_value);
