...
public class hdf5_h extends hdf5_h_1 {
     ...
     * }
     */
    public static FunctionDescriptor H5VL_native_register$descriptor() {
        return H5VL_native_register.DESC;
    }
     ...
     * }
     */
    public static MethodHandle H5VL_native_register$handle() {
        return H5VL_native_register.HANDLE;
    }
     ...
     * }
     */
    public static MemorySegment H5VL_native_register$address() {
        return H5VL_native_register.ADDR;
    }
    ...
    public static MemorySegment H5_PACKAGE_STRING() {
        class Holder {
            static final MemorySegment H5_PACKAGE_STRING
                = hdf5_h.LIBRARY_ARENA.allocateFrom("HDF5 1.15.0");
        }
    ...
    public static MemorySegment H5_PACKAGE_VERSION() {
        class Holder {
            static final MemorySegment H5_PACKAGE_VERSION
                = hdf5_h.LIBRARY_ARENA.allocateFrom("1.15.0");
        }
