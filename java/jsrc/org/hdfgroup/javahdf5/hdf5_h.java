...
public class hdf5_h extends hdf5_h_1 {
    ...
    public static int H5Pset_filter(long plist_id, int filter, int flags, long cd_nelmts,
                                    MemorySegment c_values)
    {
        var mh$ = H5Pset_filter.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("H5Pset_filter", plist_id, filter, flags, cd_nelmts, c_values);
            }
    ...
    private static class H5VL_native_register {
        public static final FunctionDescriptor DESC = FunctionDescriptor.of(hdf5_h.C_LONG);

        public static final MemorySegment ADDR = hdf5_h.findOrThrow("H5VL_native_register");
     ...
     * }
     */
    public static FunctionDescriptor H5VL_native_register$descriptor() { return H5VL_native_register.DESC; }
     ...
     * }
     */
    public static MethodHandle H5VL_native_register$handle() { return H5VL_native_register.HANDLE; }
     ...
     * }
     */
    public static MemorySegment H5VL_native_register$address() { return H5VL_native_register.ADDR; }
    ...
    {
        var mh$ = H5VL_native_register.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("H5VL_native_register");
            }
    ...
    private static class H5VL_pass_through_register {
        public static final FunctionDescriptor DESC = FunctionDescriptor.of(hdf5_h.C_LONG);

        public static final MemorySegment ADDR = hdf5_h.findOrThrow("H5VL_pass_through_register");
     ...
     * }
     */
    public static FunctionDescriptor H5VL_pass_through_register$descriptor()
    {
        return H5VL_pass_through_register.DESC;
    }
     ...
     * }
     */
    public static MethodHandle H5VL_pass_through_register$handle()
    {
        return H5VL_pass_through_register.HANDLE;
    }
     ...
     * }
     */
    public static MemorySegment H5VL_pass_through_register$address()
    {
        return H5VL_pass_through_register.ADDR;
    }
    ...
    {
        var mh$ = H5VL_pass_through_register.HANDLE;
        try {
            if (TRACE_DOWNCALLS) {
                traceDowncall("H5VL_pass_through_register");
            }
            return (long)mh$.invokeExact();
        }
        catch (Throwable ex$) {
    ...
    {
        class Holder {
            static final MemorySegment H5_PACKAGE_STRING = hdf5_h.LIBRARY_ARENA.allocateFrom("HDF5 1.15.0");
        }
    ...
    {
        class Holder {
            static final MemorySegment H5_PACKAGE_VERSION = hdf5_h.LIBRARY_ARENA.allocateFrom("1.15.0");
        }
    ...
    {
        class Holder {
            static final MemorySegment H5_VERSION = hdf5_h.LIBRARY_ARENA.allocateFrom("1.15.0");
        }
    ...
    {
        class Holder {
            static final MemorySegment H5_VERS_STR = hdf5_h.LIBRARY_ARENA.allocateFrom("1.15.0");
        }
    ...
    public static MemorySegment H5_VERS_INFO()
    {
        class Holder {
            static final MemorySegment H5_VERS_INFO =
                hdf5_h.LIBRARY_ARENA.allocateFrom("HDF5 library version: 1.15.0");
        }
