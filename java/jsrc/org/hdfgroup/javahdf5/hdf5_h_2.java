...
public class hdf5_h_2 {
    ...
    static final SymbolLookup SYMBOL_LOOKUP = SymbolLookup.libraryLookup(System.mapLibraryName("libhdf5"), LIBRARY_ARENA)
    ...
    private static final int H5_USE_116_API_DEFAULT = (int)1L;
    /**
     * {@snippet lang=c :
     * #define H5_USE_116_API_DEFAULT 1
     * }
     */
    public static int H5_USE_116_API_DEFAULT() {
        return H5_USE_116_API_DEFAULT;
    }
    ...
    private static final int H5_VERS_MINOR = (int)15L;
    /**
     * {@snippet lang=c :
